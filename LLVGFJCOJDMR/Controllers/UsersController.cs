...
namespace LLVGFJCOJDMR.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Image,Id,RolId,UserName,Password,Email,Status")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Image,Id,RolId,UserName,Password,Email,Status")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
